...
<br><img src="assets/images/petals_startingicon-plus_centered.png" alt="'+' button, centered" title="'+' button, centered" style="display: inline-block; margin: 0 auto" width="50"><br>
...
| 5 | 60 x 60 | 85 | 2 | 85 px makes icons close enough, good compromise between clarity and compactness. <br><img src="assets/images/petals_iconqty-5_dist-85px_PIby4.png" alt="Example with 5 icons, 85px, pi/4 intervals" title="Example with 5 icons, 85px, pi/4 intervals" style="display: inline-block; margin: 0 auto" width="50"><br> |
